...
public class ExceptionUtils {
    ...
    private static HttpResponse getHttpResponse(HttpServletResponse response, HttpStatus httpStatus, String message, String developerMessage) {
        HttpResponse<Object> httpResponse = HttpResponse.error(httpStatus, message, developerMessage);
